...
ARG GO_ENV_PACKAGE_NAME=github.com/sinlov/drone-feishu-group-robot
ARG GO_ENV_ROOT_BUILD_BIN_NAME=drone-feishu-group-robot
ARG GO_ENV_ROOT_BUILD_BIN_PATH=build/${GO_ENV_ROOT_BUILD_BIN_NAME}
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/drone-feishu-group-robot/main.go
