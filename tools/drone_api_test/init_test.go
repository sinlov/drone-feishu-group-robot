...
const (
	...
	envKeyDroneServerUrl              = "DRONE_SERVER_URL"
	envKeyPluginDroneSystemAdminToken = "PLUGIN_DRONE_SYSTEM_ADMIN_TOKEN"
	envKeyDroneRepoOwner              = "DRONE_REPO_OWNER"
	envKeyDroneRepoName               = "DRONE_REPO_NAME"
)

var (
	envDebug                       = false
	envDroneServerUrl              string
	envPluginDroneSystemAdminToken string
	envDroneRepoOwner              string
	envDroneRepoName               string
)

func envCheck(t *testing.T) bool {
	mustSetEnvList := []string{
		envKeyDroneServerUrl,
		envKeyPluginDroneSystemAdminToken,
		envKeyDroneRepoOwner,
		envKeyDroneRepoName,
	}
...
func init() {
	...
	envDroneServerUrl = fetchOsEnvStr(envKeyDroneServerUrl, "")
	envPluginDroneSystemAdminToken = fetchOsEnvStr(envKeyPluginDroneSystemAdminToken, "")
	envDroneRepoOwner = fetchOsEnvStr(envKeyDroneRepoOwner, "")
	envDroneRepoName = fetchOsEnvStr(envKeyDroneRepoName, "")
}
